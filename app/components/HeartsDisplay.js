  ...
  if (compact) {
    return (
      <div className="flex items-center gap-1">
        {isPremium ? (
          <span className="text-lg">&#10084;&#65039; &infin;</span>
        ) : (
          <>
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6 border border-gray-100 dark:border-gray-700">
      ...
      {isPremium ? (
        <div className="text-center py-8">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Premium members never run out of hearts!</p>
        </div>
      ) : (
        <>
          ...
          <div className="text-center">
            ...
            {hearts < MAX_HEARTS && (
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-4">
                <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Next heart in:</p>
                <p className="text-2xl font-black text-blue-600 dark:text-blue-400">{timeRemaining}</p>
              </div>
            )}

            {hearts === 0 && (
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 mb-4">
                <p className="text-sm font-semibold text-red-700 dark:text-red-300 mb-2">Out of hearts!</p>
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-3"><strong>How hearts work:</strong></p>
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 max-w-md w-full border border-gray-100 dark:border-gray-700">
        <div className="text-center mb-6">
          ...
          <h2 className="text-3xl font-black text-gray-900 dark:text-white mb-2">Out of Hearts!</h2>
          <p className="text-gray-600 dark:text-gray-400">
            You have run out of hearts. Wait for them to regenerate or upgrade to Premium!
          </p>
        </div>
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-6">
          <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Next heart in:</p>
          <p className="text-3xl font-black text-blue-600 dark:text-blue-400">{timeRemaining}</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500 dark:text-gray-400">Hearts regenerate automatically 1 per hour</p>
        </div>
      </div>
    </div>
  );
